    ...
    public function STripeCharge(Request $request)
    {
          ...
          $email=Auth::user()->email;
    	   $total=$request->total;
			...
			\Stripe\Stripe::setApiKey('sk_test_51LS2zCAH3jwDLqQV420eTDa3n5PiqnEXizeZpaxxc1pSOnx9lT0gElfb80AOHMORT3O8x18qMFtSahdaFCrSxHM300BRAbnQ2F');
			...
			$charge = \Stripe\Charge::create([
			    'amount' => $total*100,
			    'currency' => 'usd',
			    'description' => 'Echo store order deteils',
			    'source' => $token,
