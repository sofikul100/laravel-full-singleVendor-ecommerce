                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            ...
                            <div class="newsletter_title" style="font-weight: bold">Sign up for Newsletter</div>
                            <div class="newsletter_text"><p>...and receive so many offer </p></div>
                        </div>
                        <div class="newsletter_content clearfix">
                            ...
                            <div class="newsletter_unsubscribe_link"><a href="#" class="btn btn-danger btn-sm" id="unsubscribe" style="color:white;height: 50px;">unsubscribe</a></div>
                        </div>
                    </div>
                </div>
            </div>
